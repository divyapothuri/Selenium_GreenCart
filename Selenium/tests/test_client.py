...
@allure.parent_suite("Client practice")
...
def test_login(driver, logger):
    ...
    logger.info("Starting the Login form client practice automation script.")
    logger.info("Launch angular practice page")
    driver.get("https://rahulshettyacademy.com/client/#/auth/login")
    print(driver.title)
    print(driver.current_url)
    client = Client(driver, logger)
    ...
    #client.test_reg(name, email, password, phonenumber)
    client.test_login(email,password)
    client.test_order()