...
def test_buy_phone(driver, logger):
    ...
    with allure.step("phones dashboard"):
        logger.info("Add product to cart")
        phone = PhoneDashboard(driver, logger)
        phone.test_add_phones()
        phone.test_click_checkout()
        phone_checkout = PhoneCheckout(driver,logger)
        phone_checkout.test_phone_checkout()
        bill = PhoneBilling(driver, logger)
        bill.test_phone_bill()